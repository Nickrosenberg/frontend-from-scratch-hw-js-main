...
prevButton.addEventListener('click', () => {
    currentIndex = (currentIndex - 1 + WEB_TECH_IMAGES.length) % WEB_TECH_IMAGES.length; // Уменьшаем индекс и обеспечиваем цикличность
    imgElement.src = WEB_TECH_IMAGES[currentIndex]; // Обновляем источник изображения
});

// Обработчик для кнопки "next"
nextButton.addEventListener('click', () => {
    currentIndex = (currentIndex + 1) % WEB_TECH_IMAGES.length; // Увеличиваем индекс и обеспечиваем цикличность
    imgElement.src = WEB_TECH_IMAGES[currentIndex]; // Обновляем источник изображения
});